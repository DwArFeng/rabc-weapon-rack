...
public class ValidationStringIdKey implements Serializable {
    ...
    public ValidationStringIdKey() {
    }

    public ValidationStringIdKey(String id) {
        this.id = id;
    }
    ...
    public boolean equals(Object o) {
        ...
        ValidationStringIdKey that = (ValidationStringIdKey) o;

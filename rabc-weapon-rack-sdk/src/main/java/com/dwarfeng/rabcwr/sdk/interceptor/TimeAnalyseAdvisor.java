package com.dwarfeng.rabcwr.sdk.interceptor;
...
public class TimeAnalyseAdvisor {
    ...
    @Around("@annotation(com.dwarfeng.rabcwr.sdk.interceptor.TimeAnalyse) || @within(com.dwarfeng.rabcwr.sdk.interceptor.TimeAnalyse)")
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        LOGGER.debug("进入增强方法");
        String className = pjp.getSignature().getDeclaringTypeName();
        String methodName = pjp.getSignature().getName();
        LOGGER.debug("获得方法名称 " + methodName);
        LOGGER.info("方法 " + className + "." + methodName + " 开始计时...");
